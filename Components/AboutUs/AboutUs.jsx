...
export default function AboutUs() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const sections = [storyRef, philosophyRef, servicesRef, whyUsRef, teamRef, ctaRef]
      ...
      sections.forEach((sectionRef) => {
        if (sectionRef.current) {
          ...
          gsap.utils.toArray(sectionRef.current.querySelectorAll(".vintage-card")).forEach((card) => {
            const tl = gsap.timeline({ paused: true })
            tl.to(card, { scale: 1.08, duration: 0.4, ease: "power2.out" })
            tl.to(card.querySelector(".card-shadow"), { opacity: 0.4, duration: 0.4 }, 0)
      ...
      if (servicesRef.current) {
        gsap.utils.toArray(servicesRef.current.querySelectorAll('.horizontalServiceCard')).forEach(card => {
        ...
        // Add the scroll trigger animation for the cards themselves
         gsap.from(servicesRef.current.querySelectorAll('.horizontalServiceCard'), {
            opacity: 0,
            y: 80,
            stagger: 0.1,
            duration: 1,
  ...
  return (
    <div ref={containerRef} className={styles.container}>
      <section ref={heroRef} className={`${styles.storySection} ${styles.heroSection}`}>
        ...
        <div className={`${styles.storyContent} ${styles.heroContent}`}>
          <div className={`hero-content ${styles.heroText}`}>
            ...
            <h1 className={`${styles.heroTitle} typewriter-text`}>Engineering Beauty Since 2002</h1>

            <h2 className={styles.heroSubtitle}>{/* Engineering Beauty Since 2002 */}</h2>

            <p className={styles.heroDescription}>
              Designing and installing premium tensile and shading solutions — where geometry meets craftsmanship.
            </p>

            <button className={`${styles.primaryButton} ${styles.heroButton}`}>Get in Touch</button>
          </div>
        </div>
      ...
      <section ref={storyRef} className={`${styles.storySection} ${styles.offGoldSection}`}>
        <div className={styles.chapterSection}>
          ...
          <div className={`fade-up ${styles.chapterContent}`}>
            <div className={styles.storyText}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Our Story"></h2>

              <div className={styles.chapterParagraphs}>
                <p className={styles.chapterDescription}>
                  La Fabrica Exteriors was founded in 2002 in Pune with a simple mission: to create beautiful,
                  functional outdoor spaces through expertly designed and installed tensile structures and shading
                  solutions.
                </p>
                <p className={styles.chapterSubtext}>
                  What started as a small operation has grown into one of Maharashtra's most trusted names in
                  architectural fabric structures. Our journey has been defined by an unwavering commitment to quality
                  craftsmanship, innovative design, and exceptional customer service.
                </p>
                <p className={styles.chapterSubtext}>
                  Over two decades, we've completed hundreds of projects across residential, commercial, and industrial
                  sectors. From elegant residential canopies to large-scale commercial installations, each project
                  reflects our dedication to combining engineering precision with aesthetic beauty.
                </p>
                <p className={styles.chapterSubtext}>
                  Today, La Fabrica Exteriors continues to push the boundaries of what's possible with tensile
                  architecture, always staying true to our founding principles of quality, reliability, and customer
                  satisfaction.
                </p>
              </div>
            </div>
      ...
      <section ref={philosophyRef} className={`${styles.storySection} ${styles.blackSection}`}>
        <div className={styles.storyContent}>
          <div className={styles.gridContainer}>
            <div className={`fade-up ${styles.philosophyHeader}`}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Our Philosophy"></h2>
              <p className={`${styles.chapterDescription} ${styles.philosophyHeaderText}`}>
                At La Fabrica Exteriors, we believe that every structure should be a perfect marriage of form and
                function. Our approach is built on four fundamental principles that guide every project we undertake.
              </p>
            </div>
            ...
            {[
              ...
              <div key={index} className={`vintage-card fade-up ${styles.gridCard}`}>
      ...
      <section ref={whyUsRef} className={`${styles.storySection} ${styles.blueSection}`}>
        <div className={styles.storyContent}>
          <div className={styles.whyUsContainer}>
            <div className={`fade-up ${styles.whyUsHeader}`}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Why Clients Choose Us"></h2>
            </div>
            ...
            <div className={`fade-up ${styles.accordionContainer}`}>
              {[
                ...
                <div key={index} className={styles.accordionItem}>
                  <button onClick={() => toggleAccordion(index)} className={styles.accordionButton}>
                    ...
                    <ChevronDown
                      className={`${styles.accordionChevron} ${
                        openAccordion === index ? styles.accordionChevronOpen : ""
                      }`}
                    />
                  </button>
                  ...
                  <div
                    className={`${styles.accordionContentWrapper} ${
                      openAccordion === index ? styles.accordionContentWrapperOpen : ""
                    }`}
                  >
                    <div className={styles.accordionContent}>{point.description}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section ref={teamRef} className={`${styles.storySection} ${styles.offGoldSection}`}>
        <div className={styles.chapterSection}>
          <div className={`fade-up ${styles.chapterContent}`}>
            <div className={styles.storyText}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Our Team"></h2>
              <div className={styles.teamParagraphs}>
                <p className={styles.chapterDescription}>
                  Our team combines decades of experience in structural engineering, fabric architecture, and project
                  management. Led by seasoned professionals who understand both the technical and aesthetic aspects of
                  tensile structures, we bring together expertise in design, engineering, fabrication, and installation.
                </p>
                <p className={styles.chapterSubtext}>
                  Every team member shares our commitment to excellence and takes pride in delivering solutions that
          ...
          <div className={`fade-up ${styles.chapterContent}`}>
            <div className={styles.storyText}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Our journey"></h2>
                ...
                {[
                  {
                    year: "2002",
                    title: "The Beginning",
                    description: "Founded in Pune with a vision to create beautiful, functional outdoor spaces.",
                  },
                  {
                    year: "2010s",
                    title: "Growth & Expansion",
                    description: "Expanded operations across Maharashtra, completing hundreds of successful projects.",
                  },
                  {
                    year: "Today",
                    title: "Industry Leadership",
                    description: "Recognized as one of Maharashtra's most trusted names in tensile architecture.",
                  },
                ].map((milestone, index) => (
      ...
      <section ref={ctaRef} className={`${styles.storySection} ${styles.futureSection}`}>
        <div className={styles.storyImage}>
          <img
        ...
        <div className={styles.storyContent}>
          <div className={`fade-up ${styles.futureContent}`}>
            <div className={styles.futureText}>
              ...
              <h2 className={`${styles.chapterTitle} typewriter-text`} data-text="Ready to Start?"></h2>

              <p className={styles.futureDescription}>Let's talk about your site, shade goals and budget.</p>

              <button className={`${styles.primaryButton} ${styles.ctaButton}`}>Request a Consultation</button>

              <div className={styles.ctaInfoBox}>
                <p className={styles.ctaInfoText}>
                  Call us at <span className={styles.ctaInfoHighlight}>[phone]</span> or email{" "}
                  <span className={styles.ctaInfoHighlight}>[email]</span> — or use the form to upload photos and
                  basic dimensions and we'll respond with a tailored estimate.
                </p>
              </div>
            </div>
          </div>
